...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        starCaptionClasses: {
            ...
            6.1: 'label label-success',
            6.2: 'label label-success',
            6.3: 'label label-success',
            6.4: 'label label-success',
            6.5: 'label label-success',
            6.6: 'label label-success',
            6.7: 'label label-success',
            6.8: 'label label-success',
            6.9: 'label label-success',
            7: 'label label-success',
            7.1: 'label label-success',
            7.2: 'label label-success',
            7.3: 'label label-success',
            7.4: 'label label-success',
            7.5: 'label label-success',
            7.6: 'label label-success',
            7.7: 'label label-success',
            7.8: 'label label-success',
            7.9: 'label label-success',
            8: 'label label-danger',
            8.1: 'label label-danger',
            8.2: 'label label-danger',
            8.3: 'label label-danger',
            8.4: 'label label-danger',
            8.5: 'label label-danger',
            8.6: 'label label-danger',
            8.7: 'label label-danger',
            8.8: 'label label-danger',
            8.9: 'label label-danger',
            9: 'label label-danger',
            9.1: 'label label-danger',
            9.2: 'label label-danger',
            9.3: 'label label-danger',
            9.4: 'label label-danger',
            9.5: 'label label-danger',
            9.6: 'label label-danger',
            9.7: 'label label-danger',
            9.8: 'label label-danger',
            9.9: 'label label-danger',
